...
7. 深读论文与已有讲解文档，按“直白核心定位 → 研究矛盾 → 4—7 步完整训练主线 → 图中模块与信息流 → 训练/冻结关系 → 推理与部署组件 → 实验含义与边界”完成“研究方法详细解读”；事实、材料解读与个人判断分开。
